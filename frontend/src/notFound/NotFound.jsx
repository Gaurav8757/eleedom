...
function NotFound() {
  ...
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-slate-200">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-500 font-semibold tracking-wide my-12">
          Sorry, the page you are looking for could not be found.
        </p>
        <button
          onClick={handleGoBack}
          className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 font-semibold  tracking-wider text-gray-100 px-3 py-2 rounded transition duration-150"
        >
