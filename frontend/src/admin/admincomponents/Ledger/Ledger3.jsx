...
function Ledger3() {
  ...
  const fetchFilteredData = async (filterOptions) => {
    try {
      // Manually construct the query string for the company parameter without encoding
      const queryParams = {
        ...filterOptions,
      };
      ...
      const response = await axios.get(`${VITE_DATA}/leger/view`, {
        ...
        paramsSerializer: (params) => {
          // Build query string with raw "company" value
  ...
  return (
    <section className="container-fluid relative  p-0 sm:ml-48 bg-white">
      <div className="container-fluid   p-1 border-gray-200 border-dashed rounded-lg dark:border-gray-700 bg-white">
        <div className="relative w-full lg:w-fulllg:p-1 rounded shadow-xl text-2xl items-center bg-slate-200">
