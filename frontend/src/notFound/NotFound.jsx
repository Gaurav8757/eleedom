      ...
      <div className="bg-slate-200">
        ...
        >
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            ...
            <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-500 ">
              Page Not Found
            </p>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12 tracking-wider font-semibold">
