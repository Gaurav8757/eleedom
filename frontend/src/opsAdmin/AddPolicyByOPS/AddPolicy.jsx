...
function AddPolicy() {
  ...
  return (
    <section className="container-fluid relative h-screen p-0 sm:ml-40 bg-white">
      <div className="container-fluid justify-center p-2 border-gray-200 border-dashed rounded-lg  bg-white">
        <h1 className="font-semibold text-2xl text-orange-700 my-1">
          Create Policy
        </h1>
        <div className="relative w-full lg:w-full p-0 lg:p-4 rounded-xl shadow-xl text-2xl items-center mt-3 bg-slate-200">
          <div className="flex flex-wrap justify-between">
            ...
            <div className="flex flex-col p-2 text-start w-full lg:w-1/5">
              <label className="text-base mx-1">
                Policy Made By:<span className="text-red-600 font-bold">*</span>
              </label>
              <select
                className="input-style rounded text-base cursor-pointer"
                type="text"
                name="staffName"
                value={staffName}
                ...
                onChange={(e) => {
                  ...
                  const selectedEmployee = APIData.find(
                    (emp) => emp.empname === e.target.value
                  );
